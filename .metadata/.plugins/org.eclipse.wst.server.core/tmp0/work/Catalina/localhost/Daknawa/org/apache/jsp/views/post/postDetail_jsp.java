 ...
 * Generated at: 2023-04-23 09:37:52 UTC
...
public final class postDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/post/../common/menubar.jsp", Long.valueOf(1682241112684L));
  }
  ...
  static {
    ...
    _jspx_imports_packages.add("com.kh.post.model.vo");
 ...
 session.removeAttribute("alertMsg"); 
      ...
      out.write("    \r\n");
      out.write("    <br>\r\n");
      out.write("    <h2 align=\"center\">게시판 상세 조회</h2>\r\n");
      out.write("    <br>\r\n");
      out.write("    \r\n");
      out.write("\r\n");
      out.write("        <div>\r\n");
      out.write("         <table class=\"outer\" border=\"1\" style=\"text-align: center;\">\r\n");
      out.write("            <div>\r\n");
      out.write("            	<form>\r\n");
      out.write("                <thead>\r\n");
      out.write("                    <tr>\r\n");
      out.write("                        <th widtd=\"30\">");
      ...
      out.write("                    </thead>\r\n");
      out.write("                    <tr> \r\n");
      out.write("                        <td id=\"contnet-1\" colspan=\"4\">\r\n");
      out.write("                            <p>\r\n");
      out.write("                            ");
 ...
 if(at == null) { 
      ...
      out.write("            <a href=\"plist.bo?currentPage=1\" class=\"btn btn-secondary btn-sm\">목록</a>\r\n");
      out.write("				\r\n");
      out.write("              ");
 ...
 if(loginUser != null) { 
      ...
      out.write("                        </td>\r\n");
      out.write("                        <td>\r\n");
      out.write("                            <button onclick=\"insertReply();\">댓글등록</button>\r\n");
      out.write("                        </td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                ");
 } else { 
      ...
      out.write("                        <th>댓글</th>\r\n");
      out.write("                        <th>\r\n");
      out.write("                            <textarea cols=\"50\" rows=\"3\" style=\"resize : none;\" readonly>로그인 후 가능한 서비스 입니다.</textarea>\r\n");
      out.write("                        </th>\r\n");
      out.write("                        <td>\r\n");
      ...
      out.write("\r\n");
      out.write("                    // 실시간 댓글 조회, 5초 간격으로 조회\r\n");
      out.write("                    setInterval(selectReplyList, 500000);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("                             console.log(result); //성공했다면 1, 실패했다면 0\r\n");
      out.write("\r\n");
      out.write("                            if(result > 0) { // 댓글 작성 성공\r\n");
      out.write("\r\n");
      out.write("                                // 갱식된 댓글 리스트 조회\r\n");
      out.write("                                selectReplyList();\r\n");
      out.write("\r\n");
      out.write("                                // 댓글 작성용 textarea 조회\r\n");
      ...
      out.write("\r\n");
      out.write("                                result += \"<tr>\"\r\n");
      out.write("                                result += \"<td>\" + list[i].memberNo + '<i class\"fa-regular\"></i>' + \"</td>\";\r\n");
      out.write("                                result += \"<td id='reply'>\" + list[i].replyContent + \"</td>\";\r\n");
      out.write("                                result += \"<td>\" + list[i].createDate + \"</td>\"; \r\n");
      out.write("\r\n");
      out.write("                                if(\"");
      out.print( loginUser.getUserNickName() );
      out.write("\" === list[i].memberNo) {\r\n");
      out.write("                                	result += \"<td><span style='cursor : pointer;' onClick=Reply('\" + list[i].replyContent + \"','\" + list[i].replyNo + \"'); >수정</span></td>\";\r\n");
      out.write("                                	result += \"<td><span style='cursor : pointer;' onClick=deleteReply(\" + list[i].replyNo + \");>삭제</span></td>\";\r\n");
      out.write("                                } \r\n");
      out.write("                                result += \"</tr>\"\r\n");
      out.write("                                \r\n");
      ...
      out.write("                        },\r\n");
      out.write("                        error : function() {\r\n");
      out.write("                            alert(\"댓글 조회를 실패하셨습니다\");\r\n");
      out.write("                        }\r\n");
      out.write("                    });\r\n");
      out.write("                }\r\n");
      out.write("                \r\n");
      out.write("                function Reply(content, rno) {\r\n");
      out.write("                	console.log(content);\r\n");
      out.write("                	console.log(rno);\r\n");
      out.write("                	$(\"#reply\").html(\"<textarea id='replyContent1' cols='50' rows='1' style=' width: 350px; resize: none; border: 1px solid black;'>\"+ content +\"</textarea><button style='width : 50px' onclick='updateReply(\"+ rno + \");'>완료</button>\");	\r\n");
      out.write("                };\r\n");
      out.write("                \r\n");
      out.write("                // 댓슬 수정용 함수\r\n");
      out.write("                function updateReply(rno) {\r\n");
      out.write("                	// 댓글 수정용 AJAX\r\n");
      out.write("                	$.ajax({\r\n");
      out.write("                		url : \"reupdate.po\",\r\n");
      out.write("                		type : \"post\",\r\n");
      out.write("                		data : {\r\n");
      out.write("                			rno : rno,\r\n");
      out.write("                			content : $(\"#replyContent1\").val()\r\n");
      out.write("                		},\r\n");
      out.write("                		success : function(result) {\r\n");
      out.write("                			// 댓글 수정 성공 시 댓글 목록 다시 조회\r\n");
      out.write("                			// console.log(result);\r\n");
      out.write("                			if(result > 0) {\r\n");
      out.write("                				selectReplyList();\r\n");
      out.write("                				\r\n");
      out.write("                				// 댓글 수정 후 댓글 내용 초기화\r\n");
      out.write("                				$(\"#replyContent\").val(\"\");\r\n");
      out.write("                			} else {\r\n");
