                        ...
                        <form id="update-form" action="<%= contextPath %>/insert.qna" method="post" >
                            ...
                            <div class="form-example-int mg-t-15">
                                <div class="form-group">
                                    <label>문의제목</label>
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control input-sm" value="" name="askTitle">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 15px;">
                                    <div class="form-group">
                                        <div class="nk-int-st">
                                            <textarea class="form-control" rows="5" name="askContent" placeholder="답변 내용을 적어주세요."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-example-int mg-t-15" style="text-align: center; margin-top: 25px;">
                                ...
                                <button class="btn btn-success notika-btn-success" style="margin: 0 2px;" type="none" onclick="window.history.back()">취소</button>
                            </div>
                        </form>
                    </div>
                </div>
