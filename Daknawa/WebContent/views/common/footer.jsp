      ...
      <body>
        <div style="height : 0px; margin-top: 80px;">
          ...
          <img
            ...
            onclick="window.open('https://namu.wiki/w/%EC%B9%98%ED%82%A8', '_blank')"
          >
              ...
              <div class="footer7-content" style="margin-bottom : 0px; height : ;">
                ...
                <div class="footer7-links">
                  <span class="footer7-text TextRegularSemiBold">
                    ...
                    onclick="window.open('https://m.bbq.co.kr/main.asp', '_blank')"
                  	/>
                    </span>
                  </span>
                  ...
                  <span class="footer7-text02 TextRegularSemiBold">
                    ...
                    class="footer7-logo1"
                    style="height : 65px; width : 75px; "
                    onclick="window.open('https://www.bhc.co.kr/', '_blank')"
                  />
                    </span>
                  </span>
                  <span class="footer7-text04 TextRegularSemiBold">
                    ...
                    onclick="window.open('https://www.goobne.co.kr/', '_blank')"
                  />
                    </span>
                  </span>
                  ...
                  <span class="footer7-text06 TextRegularSemiBold">
                    ...
                    class="footer7-logo1"
                    style="height : 65px; width : 75px;"
                    onclick="window.open('http://www.9922.co.kr/', '_blank')"
                  ...
                  <span class="footer7-text08 TextRegularSemiBold">
                    ...
                    class="footer7-logo1"
                    style="height : 65px; width : 75px; "
                    onclick="window.open('http://10966.mbym.co.kr/', '_blank')"
